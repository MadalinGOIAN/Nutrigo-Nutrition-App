...
public class ServiciuIstoric : ControllerBase
{
    private readonly BdLicentaContext contextBd;

    public ServiciuIstoric(BdLicentaContext contextBd)
    {
    ...
    // Get("numeUtilizator/data/denumireAliment")
    ...
    // Post
    public async Task<ActionResult<IstoricDTO>> AdaugaInregistrare(IstoricDTO istoricDTO)
    {
    ...
    public async Task<ActionResult<IstoricDTO>> ActualizeazaInregistrare(
        ...
        DateTime data,
        string denumireAliment,
        IstoricDTO istoricDTOActualizat)
    {
    ...
    // Delete("numeUtilizator/data/denumireAliment")
